\thesissetup{
    ...
    keywords    = {lens quality, image analysis, python, test chart, image
artifact, user interface, gphoto2, photography},
    TeXkeywords = {lens quality, image analysis, python, test chart, image
artifact, user interface, gphoto2, photography},
    abstract    = {%
